...
namespace VooyFramework.Microservices.Product.API.Application.Behaviors
{
    public class TransactionBehaviour<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
    {
        private readonly ILogger<TransactionBehaviour<TRequest, TResponse>> _logger;
        private readonly ProductContext _dbContext;
        private readonly IntegrationEvents.IProductIntegrationEventService _productIntegrationEventService;

        public TransactionBehaviour(ProductContext dbContext,
            IntegrationEvents.IProductIntegrationEventService productIntegrationEventService,
